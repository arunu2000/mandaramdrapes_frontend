...
const WishlistProductCard = ({ product, cardVariants }) => {
    const { toggleWishlist } = useWishlist();
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-10">
                ...
                {loading ? (
                    ...
                    >
                        ...
                        <Link to="/products" className="inline-block border-b border-gray-900 text-gray-900 pb-1 text-sm uppercase tracking-widest hover:text-indigo-600 hover:border-indigo-600 transition-colors">
                            Continue Shopping
                        </Link>
                    </motion.div>
                ) : (
