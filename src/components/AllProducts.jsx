...
//       <main className="w-full max-w-none px-4 py-8 mt-24">
...
//         {/* Products grid */}
// <div className="mt-8 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:px-45 lg:grid-cols-5 xl:gap-x-8">
//   {loading && items.length === 0
//     ? Array.from({ length: filters.limit }).map((_, i) => (
//         <SkeletonCard key={i} />
//       ))
...
function SkeletonCard() {
  return (
    <div className="group relative  rounded-md p-3 bg-white animate-pulse">
      <div className="aspect-square w-full rounded-md bg-gray-200" />
      <div className="mt-3 h-4 bg-gray-200 w-1/2 rounded" />
      <div className="mt-2 h-4 bg-gray-200 w-1/3 rounded" />
    </div>
...
/>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 mt-32 ">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-3xl font-extrabold tracking-tight text-gray-900">
              All Products
