...
import { Truck, ShieldCheck, Star, Heart } from 'lucide-react'; // Ensure you have lucide-react installed or use your own icons
    ...
    <div className="bg-stone-50 min-h-screen font-sans text-stone-800">
      ...
      <div className="relative w-full h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <img 
          ...
          alt="Mandaram Drapes Fabric Texture" 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="order-2 md:order-1 space-y-6">
            ...
            <p className="text-stone-600 leading-relaxed text-lg">
              For us, a drape is not just a piece of cloth; it is a canvas of culture and a statement of grace.
            </p>
            <p className="text-stone-600 leading-relaxed">
              The name <strong>"Mandaram"</strong> is inspired by the simple, blooming beauty of nature. Just like the flower that brings a sense of serenity to a garden, we aim to bring elegance and poise to your wardrobe.
            </p>
            <p className="text-stone-600 leading-relaxed">
              Founded with a mission to make authentic, high-quality fabrics accessible, Mandaram Drapes is a celebration of the skilled artisans who weave magic into every thread.
            </p>
            
            {/* Signature or Founder Name (Optional) */}
            <div className="pt-4">
               <span className="font-handwriting text-2xl text-emerald-800 block">The Mandaram Team</span>
            </div>
          </div>
          
          <div className="order-1 md:order-2 relative">
            {/* Image Placeholder - Maybe an image of a saree being woven or a happy customer */}
            ...
            {/* Decorative Element */}
            <div className="absolute -bottom-6 -left-6 w-24 h-24 bg-yellow-50 rounded-full -z-10"></div>
            <div className="absolute -top-6 -right-6 w-32 h-32 bg-emerald-50 rounded-full -z-10"></div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-serif text-emerald-950 mb-4">Why Choose Mandaram?</h2>
            <p className="text-stone-500 max-w-2xl mx-auto">
              We don't just sell fabrics; we deliver an experience of luxury, comfort, and trust.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="p-8 bg-stone-50 rounded-xl text-center hover:shadow-lg transition-shadow duration-300 border border-stone-100">
      ...
      <section className="bg-emerald-900 py-20 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center space-y-8">
          <h2 className="text-3xl md:text-5xl font-serif">Join the Mandaram Family</h2>
          <p className="text-emerald-100 text-lg max-w-2xl mx-auto">
            Subscribe to receive updates on our latest collections, exclusive offers, and styling tips.
          </p>
