...
//         if (!address.lat) {
//           try {
//             await api.post("/address/save-geo", { latitude: finalLat, longitude: finalLng });
//           } catch (e) {}
//         }
...
//       {/* CHANGED: Increased max-width to screen-2xl and adjusted padding for wider displays */}
...
//         {/* CHANGED: Increased gap on XL screens */}
...
//                     <label htmlFor="address" className="block text-xs font-bold uppercase text-gray-500 mb-1">
//                       Street Address
//                     </label>
//                     <input
//                       type="text"
...
//                   <div>
//                     <label htmlFor="state" className="block text-xs font-bold uppercase text-gray-500 mb-1">
//                       State
//                     </label>
//                     <input
//                       type="text"
...
//                   <div className="sm:col-span-2">
//                     <label htmlFor="pincode" className="block text-xs font-bold uppercase text-gray-500 mb-1">
//                       Pincode
//                     </label>
//                     <input
//                       type="text"
...
//                       <span className="font-bold text-sm uppercase tracking-wide">Pay Online</span>
...
//                   >
//                     <div className="flex items-center justify-between mb-2">
//                       <span className="font-bold text-sm uppercase tracking-wide">Cash on Delivery</span>
...
//       {/* ================= MOBILE BOTTOM BAR ================= */}
//       <div className="fixed bottom-0 left-0 right-0 z-30 border-t border-gray-200 bg-white p-4 shadow-[0_-4px_20px_-5px_rgba(0,0,0,0.1)] lg:hidden">
...
//                   <h3 className="text-sm font-bold uppercase text-gray-900 mb-4">Order Summary</h3>
//                   <ul className="divide-y divide-gray-100">
//                     {cartItems.map((item) => (
//                       <li key={item._id} className="flex py-3">
//                         <img src={item.image} className="h-12 w-12 rounded-lg object-cover bg-gray-50" />
...
//working with perfect codeeeeeeeeeeeeeeeeeeeee
...
//             isRazorpayOpen ? "blur-md scale-95 pointer-events-none opacity-50" : "blur-0 scale-100 opacity-100"
//         }`}
//       >
...
//       {/* ================= MOBILE BOTTOM BAR ================= */}
//       <div className={`fixed bottom-0 left-0 right-0 z-30 border-t border-gray-200 bg-white p-4 shadow-[0_-4px_20px_-5px_rgba(0,0,0,0.1)] lg:hidden transition-all duration-300 ${isRazorpayOpen ? 'blur-md pointer-events-none' : ''}`}>
//         <div className="mb-4 flex items-center justify-between text-base font-bold text-gray-900">
//           <span>Total</span>
//           <span className="text-xl text-indigo-600">₹{totalAmount}</span>
//         </div>
...
//working i am gonna changee the locationnn for feroz ikkaaaaaaaaaaaaaaaaaaa
...
const CheckoutPage = () => {
  ...
  const handleManualSelect = async (lat, lng, displayName) => {
  ...
  const handlePlaceOrder = async () => {
    ...
    //   toast.error("Please select address from suggestions or use Auto-Detect");
    //   return;
    // }
