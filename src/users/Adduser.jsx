...
//   return (
//     <>
//      <div className="min-h-screen bg-gradient-to-b from-slate-50 via-slate-50 to-slate-100 px-2 sm:px-4 lg:px-8 py-6">
...
//                         Role & access
//                       </label>
//                       <div className="flex flex-wrap gap-1 rounded-full border border-slate-200 bg-slate-50/60 p-1 text-xs sm:text-sm">
//                         <button
//                           type="button"
//                           onClick={() =>
//                             setFormData((prev) => ({
