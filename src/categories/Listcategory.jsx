...
// const LoaderSpinner = ({ size = "md", color = "slate" }) => {
//   const sizes = {
//     sm: "h-4 w-4",
//     md: "h-5 w-5",
//     lg: "h-6 w-6"
...
//   return (
//     <div className={`fixed top-5 left-1/2 z-50 w-full max-w-md -translate-x-1/2 animate-slideDown`}>
//       <div className={`${bgColors[type]} mx-auto rounded-2xl px-6 py-4 flex items-center justify-between shadow-2xl shadow-black/10 backdrop-blur-sm`}>
...
//     <div className="h-40 w-full bg-gradient-to-r from-slate-100 to-slate-200"></div>
...
//       showToast(res.data.message || "Category updated successfully!");
...
//       const token = localStorage.getItem("token");
//       await axios.delete(
//         `${domainUrl}/category/delete/${selectedCategory._id}`,
//         {
...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 py-8 px-4 md:px-6">
//       {/* Header Section */}
...
//                 Organize and manage your product categories with precision. Track performance, 
//                 update details, and maintain your catalogue efficiently.
//               </p>
//             </div>

//             <div className="flex items-center gap-4">
//               <div className="bg-gradient-to-br from-white to-slate-50 rounded-2xl p-4 shadow-lg border border-slate-100">
//                 <div className="flex items-center gap-4">
...
//                 </div>
//                 <button className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-slate-900 to-slate-800 text-white text-sm font-medium hover:shadow-lg transition-all duration-200">
...
//                     <div className="flex items-center gap-1 px-2 py-1 rounded-full bg-gradient-to-r from-amber-500 to-amber-600 text-[10px] font-bold text-white uppercase tracking-wide">
...
//                         className="p-2 rounded-lg border border-slate-200 bg-white text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition-all duration-200"
//                         title="Edit"
//                       >
...
//                         className="p-2 rounded-lg border border-red-100 bg-red-50 text-red-600 hover:bg-red-100 hover:border-red-200 transition-all duration-200"
//                         title="Delete"
//                       >
...
//               <h3 className="text-2xl font-bold text-slate-900 mb-3">Delete Category</h3>
...
//                   className="px-6 py-3 rounded-xl bg-gradient-to-r from-red-600 to-red-500 text-white font-medium hover:shadow-lg transition-all duration-200"
//                 >
//                   Delete Category
//                 </button>
//               </div>
...
//                 <div>
//                   <div className="aspect-square w-full overflow-hidden rounded-xl bg-slate-100 mb-6">
...
//                     <div className="text-sm font-mono text-slate-700 bg-slate-50 p-3 rounded-lg">
...
const [expandedDesc, setExpandedDesc] = useState({});
 ...
 const handleUpdate = async (e) => {
  ...
  const btnClick = () => {
    navigate("/admindashboard/managecategories/addcategory")
  }
          ...
          <div className="p-4 md:p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6">
              ...
              <div className="col-span-1 md:col-span-2 lg:col-span-1 xl:col-span-2 flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <button onClick={btnClick} className="w-full cursor-pointer md:w-auto inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-slate-900 to-slate-800 text-white text-sm font-medium hover:shadow-lg transition-all duration-200">
